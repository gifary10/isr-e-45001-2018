...
function checkRequiredElements() {
    const requiredElements = [
        'clausesContainer', 'clauseDetailContainer', 'subclauseDetailContainer',
...
async function showClauseDetail(clauseNumber) {
    ...
    try {
        ...
        elements.backSubclauseBtn?.style.display === 'none';
...
function backToClauses() {
    ...
    const firstNavItem = elements.clausesNav?.firstChild;
    if (firstNavItem) {
